...
public static class DataSeeder
{
...

    {
...

        {
            ...
            new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad" , FoundedDate = new DateTime(1949, 5, 11)},
            ...
            new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay" , FoundedDate = new DateTime(1976, 7, 1)},
            new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre" , FoundedDate = new DateTime(2003, 1, 1)},
            new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo" , FoundedDate = new DateTime(2010, 1, 1)},
            new() { Name="Llaneros FC", City="Villavicencio", Stadium="Bello Horizonte" , FoundedDate = new DateTime(2012, 1, 1)},
            new() { Name="Cúcuta Deportivo", City="Cúcuta", Stadium="General Santander" , FoundedDate = new DateTime(1924, 10, 10)},
            new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo" , FoundedDate = new DateTime(1970, 1, 1)},
        };
